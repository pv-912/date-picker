			...
			for(var i=0; i<_this.displayJson.length; i++){
				(function (i) {
					...
					if(_this.wheel[i]){
						...
						if (_this.displayJson[i][j][_this.keyMap.id] == "no_slots"){ var errorStyle=' style="color:red;"' } else if (_this.displayJson[i][j][_this.keyMap.id] == "no_slot_day"){ var errorStyle=' style="text-decoration: line-through;"' } else { var errorStyle=''};
